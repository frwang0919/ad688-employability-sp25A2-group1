...
```{python}
job_postings_clean = job_postings.replace(["__", "N/A", "missing"], np.nan)

job_postings_clean = job_postings_clean.apply(pd.to_numeric, errors='ignore')

try:
    msno.heatmap(job_postings_clean)
    plt.title("Missing Values Heatmap")
    plt.show()
except Exception as e:
    print(f"⚠️ Warning: Heatmap skipped due to: {e}")
```
